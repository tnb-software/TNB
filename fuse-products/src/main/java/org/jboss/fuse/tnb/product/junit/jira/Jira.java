package org.jboss.fuse.tnb.product.junit.jira;
 ...
 * <p>
 * All jira annotations for given class / method are then stored automatically in {@link org.jboss.fuse.tnb.product.junit.jira.Jiras} annotation
 */
@Target({TYPE, METHOD})
@Retention(RUNTIME)
