...
public class SpringBootConfiguration extends CamelConfiguration {
    ...
    public static final String CAMEL_SPRINGBOOT_ARCHETYPE_GENERATED_VERSION = "camel.springboot.archetype.generated.version";
    ...
    /**
     * Defines the repository of the image generated by the deployment strategy.
     * Mandatory in {@link software.tnb.product.deploystrategy.impl.JKubeWithExternalRepoStrategy}
     * @return String, the name of the remote registry, with the organization  (ex: quay.io/repository/fuse_qe)
     */
