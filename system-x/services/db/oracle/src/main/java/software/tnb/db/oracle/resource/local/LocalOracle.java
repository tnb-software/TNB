package software.tnb.db.oracle.resource.local;

import software.tnb.common.deployment.ContainerDeployable;
import software.tnb.db.common.local.DBContainer;
import software.tnb.db.common.local.LocalDB;
import software.tnb.db.oracle.service.Oracle;

import org.testcontainers.containers.wait.strategy.Wait;

import com.google.auto.service.AutoService;

@AutoService(Oracle.class)
public class LocalOracle extends Oracle implements ContainerDeployable<DBContainer> {
