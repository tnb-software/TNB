...
public class OpenshiftMailServer extends MailServer implements ReusableOpenshiftDeployable, WithName, WithInClusterHostname, WithExternalHostname {
    ...
    private PortForward httpPortForward;
    ...
    public void openResources() {
        ...
        LOG.debug("Creating port-forward to {} for port {}", name(), httpPort());
        httpPortForward = OpenshiftClient.get().services().withName(name()).portForward(httpPort(), httpPort());
    }
