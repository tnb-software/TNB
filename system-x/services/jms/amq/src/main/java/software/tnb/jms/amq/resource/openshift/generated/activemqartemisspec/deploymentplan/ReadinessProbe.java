...
public class ReadinessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.Exec exec;

    public software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.Grpc grpc;

    public software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.HttpGet httpGet;

    public software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.TcpSocket tcpSocket;

    public software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(software.tnb.jms.amq.resource.openshift.generated.activemqartemisspec.deploymentplan.readinessprobe.TcpSocket tcpSocket) {
