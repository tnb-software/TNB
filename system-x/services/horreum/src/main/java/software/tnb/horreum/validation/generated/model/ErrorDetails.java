...
public class ErrorDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, code, path, evaluationPath, schemaPath, schemaLocation, instanceLocation, property, arguments, details, messageKey, valid, message);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("evaluationPath") != null && !jsonObj.get("evaluationPath").isJsonNull()) && !jsonObj.get("evaluationPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `evaluationPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("evaluationPath").toString()));
      }
      if ((jsonObj.get("schemaPath") != null && !jsonObj.get("schemaPath").isJsonNull()) && !jsonObj.get("schemaPath").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `schemaPath` to be a primitive type in the JSON string but got `%s`", jsonObj.get("schemaPath").toString()));
      }
