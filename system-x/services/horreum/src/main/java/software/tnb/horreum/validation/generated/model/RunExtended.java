...
public class RunExtended {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(access, owner, start, stop, id, description, testid, data, metadata, trashed, validationErrors, schemas, testname, datasets);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RunExtended.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RunExtended is not found in the empty JSON string", RunExtended.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RunExtended.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RunExtended` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
