...
public class ChangeDetectionConfig extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<RelativeDifferenceDetectionConfig> adapterRelativeDifferenceDetectionConfig = gson.getDelegateAdapter(this, TypeToken.get(RelativeDifferenceDetectionConfig.class));
            final TypeAdapter<FixedThresholdDetectionConfig> adapterFixedThresholdDetectionConfig = gson.getDelegateAdapter(this, TypeToken.get(FixedThresholdDetectionConfig.class));
            final TypeAdapter<EDivisiveDetectionConfig> adapterEDivisiveDetectionConfig = gson.getDelegateAdapter(this, TypeToken.get(EDivisiveDetectionConfig.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<ChangeDetectionConfig>() {
                ...
                public void write(JsonWriter out, ChangeDetectionConfig value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof RelativeDifferenceDetectionConfig) {
                        JsonElement element = adapterRelativeDifferenceDetectionConfig.toJsonTree((RelativeDifferenceDetectionConfig)value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof FixedThresholdDetectionConfig) {
                        JsonElement element = adapterFixedThresholdDetectionConfig.toJsonTree((FixedThresholdDetectionConfig)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: EDivisiveDetectionConfig, FixedThresholdDetectionConfig, RelativeDifferenceDetectionConfig");
                }
                ...
                public ChangeDetectionConfig read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for ChangeDetectionConfig: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be EDivisiveDetectionConfig, FixedThresholdDetectionConfig, RelativeDifferenceDetectionConfig");
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ChangeDetectionConfig with oneOf schemas: EDivisiveDetectionConfig, FixedThresholdDetectionConfig, RelativeDifferenceDetectionConfig. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
