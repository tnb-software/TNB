...
public class DatasetApi {
    ...
    public ApiResponse<DatasetSummary> getSummaryWithHttpInfo(Integer datasetId, Integer viewId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<DatasetSummary>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<LabelValue>> labelValuesWithHttpInfo(Integer datasetId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<LabelValue>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public ApiResponse<DatasetList> listBySchemaWithHttpInfo(String uri, Integer limit, Integer page, String sort, SortDirection direction) throws ApiException {
     ...
     */
    public okhttp3.Call listBySchemaAsync(String uri, Integer limit, Integer page, String sort, SortDirection direction, final ApiCallback<DatasetList> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listByTestCall(Integer testId, String filter, Integer limit, Integer page, String sort, SortDirection direction, Integer viewId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listByTestValidateBeforeCall(Integer testId, String filter, Integer limit, Integer page, String sort, SortDirection direction, Integer viewId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public DatasetList listByTest(Integer testId, String filter, Integer limit, Integer page, String sort, SortDirection direction, Integer viewId) throws ApiException {
     ...
     */
    public ApiResponse<DatasetList> listByTestWithHttpInfo(Integer testId, String filter, Integer limit, Integer page, String sort, SortDirection direction, Integer viewId) throws ApiException {
     ...
     */
    public okhttp3.Call listByTestAsync(Integer testId, String filter, Integer limit, Integer page, String sort, SortDirection direction, Integer viewId, final ApiCallback<DatasetList> _callback) throws ApiException {
    ...
    public ApiResponse<LabelPreview> previewLabelWithHttpInfo(Integer datasetId, Label label) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<LabelPreview>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
