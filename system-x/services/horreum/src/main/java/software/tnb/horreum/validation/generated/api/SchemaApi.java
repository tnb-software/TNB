...
public class SchemaApi {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call addOrUpdateTransformerValidateBeforeCall(Integer schemaId, Transformer transformer, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'schemaId' is set
        if (schemaId == null) {
     ...
     */
    public okhttp3.Call addOrUpdateTransformerAsync(Integer schemaId, Transformer transformer, final ApiCallback<Integer> _callback) throws ApiException {
    ...
    public ApiResponse<List<LabelInfo>> allLabelsWithHttpInfo(String name) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<LabelInfo>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<TransformerInfo>> allTransformersWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<TransformerInfo>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call callListCall(Integer limit, Integer page, String sort, SortDirection direction, String roles, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call callListValidateBeforeCall(Integer limit, Integer page, String sort, SortDirection direction, String roles, final ApiCallback _callback) throws ApiException {
     ...
     */
    public ApiResponse<SchemaQueryResult> callListWithHttpInfo(Integer limit, Integer page, String sort, SortDirection direction, String roles) throws ApiException {
        okhttp3.Call localVarCall = callListValidateBeforeCall(limit, page, sort, direction, roles, null);
        Type localVarReturnType = new TypeToken<SchemaQueryResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call callListAsync(Integer limit, Integer page, String sort, SortDirection direction, String roles, final ApiCallback<SchemaQueryResult> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteTransformerValidateBeforeCall(Integer schemaId, Integer transformerId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'schemaId' is set
        if (schemaId == null) {
    ...
    public ApiResponse<List<SchemaDescriptor>> descriptorsWithHttpInfo(List<Integer> id) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<SchemaDescriptor>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<SchemaExport> exportSchemaWithHttpInfo(Integer id) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<SchemaExport>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<LabelLocation>> findUsagesWithHttpInfo(String label) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<LabelLocation>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
