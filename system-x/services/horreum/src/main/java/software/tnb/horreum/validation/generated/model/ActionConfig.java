...
public class ActionConfig extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<GithubIssueCommentActionConfig> adapterGithubIssueCommentActionConfig = gson.getDelegateAdapter(this, TypeToken.get(GithubIssueCommentActionConfig.class));
            final TypeAdapter<GithubIssueCreateActionConfig> adapterGithubIssueCreateActionConfig = gson.getDelegateAdapter(this, TypeToken.get(GithubIssueCreateActionConfig.class));
            ...
            final TypeAdapter<SlackChannelMessageActionConfig> adapterSlackChannelMessageActionConfig = gson.getDelegateAdapter(this, TypeToken.get(SlackChannelMessageActionConfig.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<ActionConfig>() {
                ...
                public void write(JsonWriter out, ActionConfig value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof GithubIssueCommentActionConfig) {
                        JsonElement element = adapterGithubIssueCommentActionConfig.toJsonTree((GithubIssueCommentActionConfig)value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof GithubIssueCreateActionConfig) {
                        JsonElement element = adapterGithubIssueCreateActionConfig.toJsonTree((GithubIssueCreateActionConfig)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    ...
                    if (value.getActualInstance() instanceof SlackChannelMessageActionConfig) {
                        JsonElement element = adapterSlackChannelMessageActionConfig.toJsonTree((SlackChannelMessageActionConfig)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: GithubIssueCommentActionConfig, GithubIssueCreateActionConfig, HttpActionConfig, SlackChannelMessageActionConfig");
                }
                ...
                public ActionConfig read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for ActionConfig: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be GithubIssueCommentActionConfig, GithubIssueCreateActionConfig, HttpActionConfig, SlackChannelMessageActionConfig");
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for ActionConfig with oneOf schemas: GithubIssueCommentActionConfig, GithubIssueCreateActionConfig, HttpActionConfig, SlackChannelMessageActionConfig. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
