    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TableReportConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                    String.format("The required field(s) %s in TableReportConfig is not found in the empty JSON string",
                        TableReportConfig.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!TableReportConfig.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                    String.format("The field `%s` in the JSON string is not defined in the `TableReportConfig` properties. JSON: %s", entry.getKey(),
        ...
        if (jsonObj.get("filterLabels") != null && !jsonObj.get("filterLabels").isJsonNull() && !jsonObj.get("filterLabels").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `filterLabels` to be an array in the JSON string but got `%s`",
                jsonObj.get("filterLabels").toString()));
        }
        if ((jsonObj.get("filterFunction") != null && !jsonObj.get("filterFunction").isJsonNull()) && !jsonObj.get("filterFunction")
            .isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `filterFunction` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("filterFunction").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("categoryLabels") != null && !jsonObj.get("categoryLabels").isJsonNull() && !jsonObj.get("categoryLabels").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `categoryLabels` to be an array in the JSON string but got `%s`",
                jsonObj.get("categoryLabels").toString()));
        }
        if ((jsonObj.get("categoryFunction") != null && !jsonObj.get("categoryFunction").isJsonNull()) && !jsonObj.get("categoryFunction")
            .isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `categoryFunction` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("categoryFunction").toString()));
        }
        if ((jsonObj.get("categoryFormatter") != null && !jsonObj.get("categoryFormatter").isJsonNull()) && !jsonObj.get("categoryFormatter")
            .isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `categoryFormatter` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("categoryFormatter").toString()));
        }
        // ensure the required json array is present
        if (jsonObj.get("seriesLabels") == null) {
            throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
        } else if (!jsonObj.get("seriesLabels").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `seriesLabels` to be an array in the JSON string but got `%s`",
                jsonObj.get("seriesLabels").toString()));
        }
        if ((jsonObj.get("seriesFunction") != null && !jsonObj.get("seriesFunction").isJsonNull()) && !jsonObj.get("seriesFunction")
            .isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `seriesFunction` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("seriesFunction").toString()));
        }
        if ((jsonObj.get("seriesFormatter") != null && !jsonObj.get("seriesFormatter").isJsonNull()) && !jsonObj.get("seriesFormatter")
            .isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `seriesFormatter` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("seriesFormatter").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("scaleLabels") != null && !jsonObj.get("scaleLabels").isJsonNull() && !jsonObj.get("scaleLabels").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `scaleLabels` to be an array in the JSON string but got `%s`",
                jsonObj.get("scaleLabels").toString()));
        }
        if ((jsonObj.get("scaleFunction") != null && !jsonObj.get("scaleFunction").isJsonNull()) && !jsonObj.get("scaleFunction").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `scaleFunction` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("scaleFunction").toString()));
        }
        if ((jsonObj.get("scaleFormatter") != null && !jsonObj.get("scaleFormatter").isJsonNull()) && !jsonObj.get("scaleFormatter")
            .isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `scaleFormatter` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("scaleFormatter").toString()));
        }
        if ((jsonObj.get("scaleDescription") != null && !jsonObj.get("scaleDescription").isJsonNull()) && !jsonObj.get("scaleDescription")
            .isJsonPrimitive()) {
            throw new IllegalArgumentException(
                String.format("Expected the field `scaleDescription` to be a primitive type in the JSON string but got `%s`",
                    jsonObj.get("scaleDescription").toString()));
        }
        // ensure the json data is an array
        if (!jsonObj.get("components").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `components` to be an array in the JSON string but got `%s`",
