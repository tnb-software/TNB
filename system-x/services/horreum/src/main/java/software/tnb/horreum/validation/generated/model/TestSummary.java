...
public class TestSummary {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("watching") != null && !jsonObj.get("watching").isJsonNull() && !jsonObj.get("watching").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `watching` to be an array in the JSON string but got `%s`", jsonObj.get("watching").toString()));
      }
