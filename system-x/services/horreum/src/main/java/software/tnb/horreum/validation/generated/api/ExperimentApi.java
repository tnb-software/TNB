...
public class ExperimentApi {
    ...
    private okhttp3.Call addOrUpdateProfileValidateBeforeCall(Integer testId, ExperimentProfile experimentProfile, final ApiCallback _callback)
        throws ApiException {
     ...
     * </table>
     */
    public okhttp3.Call addOrUpdateProfileAsync(Integer testId, ExperimentProfile experimentProfile, final ApiCallback<Integer> _callback)
        throws ApiException {
    ...
    public ApiResponse<List<ConditionConfig>> modelsWithHttpInfo() throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<ConditionConfig>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<ExperimentProfile>> profilesWithHttpInfo(Integer testId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<ExperimentProfile>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public ApiResponse<List<ExperimentResult>> runExperimentsWithHttpInfo(Integer datasetId) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<List<ExperimentResult>>() {
        }.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
