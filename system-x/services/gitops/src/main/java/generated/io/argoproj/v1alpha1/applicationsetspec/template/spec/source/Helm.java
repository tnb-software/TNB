package generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source;
...
public class Helm implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.FileParameters> fileParameters;

    public java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.FileParameters> getFileParameters() {
        return fileParameters;
    }

    public void setFileParameters(java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.FileParameters> fileParameters) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.Parameters> parameters;

    public java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.Parameters> getParameters() {
        return parameters;
    }

    public void setParameters(java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.Parameters> parameters) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.ValuesObject valuesObject;

    public generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.ValuesObject getValuesObject() {
        return valuesObject;
    }

    public void setValuesObject(generated.io.argoproj.v1alpha1.applicationsetspec.template.spec.source.helm.ValuesObject valuesObject) {
