...
public class Kustomize implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.generators.list.template.spec.source.kustomize.Replicas> replicas;

    public java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.generators.list.template.spec.source.kustomize.Replicas> getReplicas() {
        return replicas;
    }

    public void setReplicas(java.util.List<generated.io.argoproj.v1alpha1.applicationsetspec.generators.list.template.spec.source.kustomize.Replicas> replicas) {
