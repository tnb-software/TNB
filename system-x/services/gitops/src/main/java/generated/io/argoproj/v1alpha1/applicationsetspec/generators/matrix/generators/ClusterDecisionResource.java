...
public class ClusterDecisionResource implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.clusterdecisionresource.LabelSelector labelSelector;

    public generated.io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.clusterdecisionresource.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(generated.io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.clusterdecisionresource.LabelSelector labelSelector) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.clusterdecisionresource.Template template;

    public generated.io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.clusterdecisionresource.Template getTemplate() {
        return template;
    }

    public void setTemplate(generated.io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.clusterdecisionresource.Template template) {
