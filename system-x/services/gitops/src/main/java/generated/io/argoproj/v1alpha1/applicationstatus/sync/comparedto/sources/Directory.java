...
public class Directory implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.sync.comparedto.sources.directory.Jsonnet jsonnet;

    public generated.io.argoproj.v1alpha1.applicationstatus.sync.comparedto.sources.directory.Jsonnet getJsonnet() {
        return jsonnet;
    }

    public void setJsonnet(generated.io.argoproj.v1alpha1.applicationstatus.sync.comparedto.sources.directory.Jsonnet jsonnet) {
