package generated.io.argoproj.v1alpha1.applicationspec.syncpolicy;
...
public class Retry implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private generated.io.argoproj.v1alpha1.applicationspec.syncpolicy.retry.Backoff backoff;

    public generated.io.argoproj.v1alpha1.applicationspec.syncpolicy.retry.Backoff getBackoff() {
        return backoff;
    }

    public void setBackoff(generated.io.argoproj.v1alpha1.applicationspec.syncpolicy.retry.Backoff backoff) {
