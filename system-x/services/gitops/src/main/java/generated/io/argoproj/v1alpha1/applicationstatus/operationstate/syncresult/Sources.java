...
public class Sources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Directory directory;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Directory getDirectory() {
        return directory;
    }

    public void setDirectory(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Directory directory) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Helm helm;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Helm getHelm() {
        return helm;
    }

    public void setHelm(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Helm helm) {
        this.helm = helm;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Kustomize kustomize;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Kustomize getKustomize() {
        return kustomize;
    }

    public void setKustomize(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Kustomize kustomize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Plugin plugin;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Plugin getPlugin() {
        return plugin;
    }

    public void setPlugin(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.syncresult.sources.Plugin plugin) {
        this.plugin = plugin;
    }
