...
public class Source implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Directory directory;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Directory getDirectory() {
        return directory;
    }

    public void setDirectory(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Directory directory) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Helm helm;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Helm getHelm() {
        return helm;
    }

    public void setHelm(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Helm helm) {
        this.helm = helm;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Kustomize kustomize;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Kustomize getKustomize() {
        return kustomize;
    }

    public void setKustomize(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Kustomize kustomize) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Plugin plugin;

    public generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Plugin getPlugin() {
        return plugin;
    }

    public void setPlugin(generated.io.argoproj.v1alpha1.applicationstatus.operationstate.operation.sync.source.Plugin plugin) {
        this.plugin = plugin;
    }
